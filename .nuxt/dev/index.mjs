...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHost, getRequestProtocol, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getQuery as getQuery$1, getRequestHeaders, setHeader, getCookie, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText, H3Error } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/h3/dist/index.mjs';
...
import { createStorage, prefixStorage, normalizeKey } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/unstorage/dist/index.mjs';
...
import { html as html$2 } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/satori-html/dist/index.js';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, joinRelativeURL, withoutTrailingSlash, withoutLeadingSlash, withLeadingSlash, isRelative, withBase } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/ufo/dist/index.mjs';
import sizeOf from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/image-size/dist/index.js';
import playwrightCore from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/playwright-core/index.mjs';
import { Launcher } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/chrome-launcher/dist/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import { createServerHead as createServerHead$1, CapoPlugin, createHeadCore } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/unhead/dist/index.mjs';
import { isVNode, toValue, version, unref } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/vue/index.mjs';
...
import { consola } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/unctx/dist/index.mjs';
import devalue from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/@nuxt/devalue/dist/devalue.mjs';
...
import { extname } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/pathe/dist/index.mjs';
...
import { postprocess, preprocess } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/micromark/dev/index.js';
...
import { markdownLineEnding, markdownSpace } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/micromark-util-chunked/dev/index.js';
...
import { normalizeUri } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/micromark-util-sanitize-uri/dev/index.js';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/shawes/git/opendevsci/longitudinal.dev/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _K1RsrR0oZN = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/shawes/git/opendevsci/longitudinal.dev";
...
const _VCfsr9 = defineEventHandler(async (e) => {
...
const _lazy_hDqJ7j = () => Promise.resolve().then(function () { return search_json_get$1; });
const _lazy_xlrUUZ = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_5mVm5x = () => Promise.resolve().then(function () { return font$1; });
const _lazy_VxuKJh = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_8Up0ZV = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '/api/search.json', handler: _lazy_hDqJ7j, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_xlrUUZ, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/__site-config__/debug.json', handler: _VCfsr9, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_5mVm5x, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_VxuKJh, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/api/_content/cache.json', handler: _N7CKZO, lazy: false, middleware: false, method: "get" },
  ...
  { route: '/_fonts/**', handler: _lazy_xlrUUZ, lazy: true, middleware: false, method: undefined },
...
const theme = {"colors":{"background":"rgb(var(--ui-background) / <alpha-value>)","foreground":"rgb(var(--ui-foreground) / <alpha-value>)","primary":{"50":"rgb(var(--color-primary-50) / <alpha-value>)","100":"rgb(var(--color-primary-100) / <alpha-value>)","200":"rgb(var(--color-primary-200) / <alpha-value>)","300":"rgb(var(--color-primary-300) / <alpha-value>)","400":"rgb(var(--color-primary-400) / <alpha-value>)","500":"rgb(var(--color-primary-500) / <alpha-value>)","600":"rgb(var(--color-primary-600) / <alpha-value>)","700":"rgb(var(--color-primary-700) / <alpha-value>)","800":"rgb(var(--color-primary-800) / <alpha-value>)","900":"rgb(var(--color-primary-900) / <alpha-value>)","950":"rgb(var(--color-primary-950) / <alpha-value>)","DEFAULT":"rgb(var(--color-primary-DEFAULT) / <alpha-value>)"},"green":{"50":"#EFFDF5","100":"#D9FBE8","200":"#B3F5D1","300":"#75EDAE","400":"#00DC82","500":"#00C16A","600":"#00A155","700":"#007F45","800":"#016538","900":"#0A5331","950":"#052e16"},"gray":{"50":"rgb(var(--color-gray-50) / <alpha-value>)","100":"rgb(var(--color-gray-100) / <alpha-value>)","200":"rgb(var(--color-gray-200) / <alpha-value>)","300":"rgb(var(--color-gray-300) / <alpha-value>)","400":"rgb(var(--color-gray-400) / <alpha-value>)","500":"rgb(var(--color-gray-500) / <alpha-value>)","600":"rgb(var(--color-gray-600) / <alpha-value>)","700":"rgb(var(--color-gray-700) / <alpha-value>)","800":"rgb(var(--color-gray-800) / <alpha-value>)","900":"rgb(var(--color-gray-900) / <alpha-value>)","950":"rgb(var(--color-gray-950) / <alpha-value>)"},"cool":{"50":"#f9fafb","100":"#f3f4f6","200":"#e5e7eb","300":"#d1d5db","400":"#9ca3af","500":"#6b7280","600":"#4b5563","700":"#374151","800":"#1f2937","900":"#111827","950":"#030712"}},"fontFamily":{"sans":["DM Sans","ui-sans-serif","system-ui","sans-serif","\"Apple Color Emoji\"","\"Segoe UI Emoji\"","\"Segoe UI Symbol\"","\"Noto Color Emoji\"","DM Sans","ui-sans-serif","system-ui","sans-serif","\"Apple Color Emoji\"","\"Segoe UI Emoji\"","\"Segoe UI Symbol\"","\"Noto Color Emoji\"","DM Sans","ui-sans-serif","system-ui","sans-serif","\"Apple Color Emoji\"","\"Segoe UI Emoji\"","\"Segoe UI Symbol\"","\"Noto Color Emoji\"","DM Sans","ui-sans-serif","system-ui","sans-serif","\"Apple Color Emoji\"","\"Segoe UI Emoji\"","\"Segoe UI Symbol\"","\"Noto Color Emoji\""]}};
...
const getClientManifest = () => import('file:///Users/shawes/git/opendevsci/longitudinal.dev/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/shawes/git/opendevsci/longitudinal.dev/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const compatibility = {"chromium":"chrome-launcher","satori":"node","resvg":"node","sharp":false,"css-inline":"node"};

const componentNames = [{"hash":"i0Vxmj8bqg","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/Users/shawes/git/opendevsci/longitudinal.dev/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/BrandedLogo.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"tBHg51xiAt","pascalName":"Frame","kebabName":"frame","path":"/Users/shawes/git/opendevsci/longitudinal.dev/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Frame.vue","category":"community","credits":"@arashsheyda <https://github.com/arashsheyda>"},{"hash":"EtP6PjHVxf","pascalName":"Nuxt","kebabName":"nuxt","path":"/Users/shawes/git/opendevsci/longitudinal.dev/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Nuxt.vue","category":"community","credits":"NuxtLabs <https://nuxtlabs.com/>"},{"hash":"LZkuSUuPEa","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/Users/shawes/git/opendevsci/longitudinal.dev/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/NuxtSeo.vue","category":"community","credits":"Nuxt SEO <https://nuxtseo.com/>"},{"hash":"KfQI8hATPp","pascalName":"Pergel","kebabName":"pergel","path":"/Users/shawes/git/opendevsci/longitudinal.dev/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Pergel.vue","category":"community","credits":"Pergel <https://nuxtlabs.com/>"},{"hash":"YDrRRvPRVl","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/Users/shawes/git/opendevsci/longitudinal.dev/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/SimpleBlog.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"wt558K6QyQ","pascalName":"UnJs","kebabName":"un-js","path":"/Users/shawes/git/opendevsci/longitudinal.dev/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/UnJs.vue","category":"community","credits":"UnJS <https://unjs.io/>"},{"hash":"6RdQZcuwZZ","pascalName":"Wave","kebabName":"wave","path":"/Users/shawes/git/opendevsci/longitudinal.dev/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Wave.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"gaB1TrbtTl","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/Users/shawes/git/opendevsci/longitudinal.dev/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/WithEmoji.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"}];
