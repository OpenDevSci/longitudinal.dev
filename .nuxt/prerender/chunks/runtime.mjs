...
const _inlineRuntimeConfig = {
  "app": {
    ...
    "buildId": "e5587220-9191-40df-ae12-0b41564b8849",
...
const handlers = [
  ...
  { route: '/api/_content/cache.1729132494611.json', handler: _6bbxUj, lazy: false, middleware: false, method: "get" },
