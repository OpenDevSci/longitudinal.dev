...
const _inlineRuntimeConfig = {
  "app": {
    ...
    "buildId": "9775e47f-d0a9-4337-9b8f-527d0c6779bb",
...
const handlers = [
  ...
  { route: '/api/_content/cache.1729133134534.json', handler: _6bbxUj, lazy: false, middleware: false, method: "get" },
