...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "0e590a07-a1da-4166-be23-6d20494c36b9",
...
const handlers = [
  ...
  { route: '/api/_content/cache.1728758568325.json', handler: _N7CKZO, lazy: false, middleware: false, method: "get" },
