import { m as mergeConfig, h as appConfig, _ as __nuxt_component_1$1, i as __nuxt_component_2, u as useUI, n as useRoute, f as useAppConfig, v as useAsyncData, w as queryContent, c as createError, x as useSeoMeta, y as findPageHeadline, d as useRouter, e as useNuxtApp, j as getULinkProps, o as normaliseOptions, p as useOgImageRuntimeConfig, s as separateProps, q as createOgImageMeta, r as getOgImagePath, t as useRequestEvent, z as _sfc_main$3$1, a as __nuxt_component_0$4, b as __nuxt_component_0$9, g as _export_sfc, k as __nuxt_component_0$6, l as useRuntimeConfig } from './server.mjs';
import { useSSRContext, defineComponent, toRef, computed, withAsyncContext, createSlots, withCtx, unref, openBlock, createBlock, createCommentVNode, createVNode, mergeProps, toDisplayString, ref, createTextVNode, watch } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderClass, ssrRenderAttrs, ssrRenderSlot, ssrInterpolate, ssrRenderList, ssrRenderAttr } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/vue/server-renderer/index.mjs';
import _sfc_main$9 from './ContentRenderer-BZ4In3mA.mjs';
...
import { appendHeader } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/h3/dist/index.mjs';
...
import { withoutTrailingSlash, withoutBase } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/ufo/dist/index.mjs';
...
import './ContentRendererMarkdown-C7LiaGWG.mjs';
          ...
          _push(ssrRenderComponent(_component_ULink, mergeProps({
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                if (link.avatar) {
                  _push2(ssrRenderComponent(_component_UAvatar, mergeProps({ ref_for: true }, { size: unref(ui).avatar.size, ...link.avatar }, {
                ...
                return [
                  ...
                  link.avatar ? (openBlock(), createBlock(_component_UAvatar, mergeProps({
                    key: 1,
                    ref_for: true
                  }, { size: unref(ui).avatar.size, ...link.avatar }, {
                    class: unref(twMerge)(unref(ui).avatar.base, link.avatarClass)
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    if (error.value || !page.value) {
      console.error("Error fetching page:", error == null ? void 0 : error.value);
      throw createError({
        statusCode: 404,
    ...
    const links = computed(
      () => {
        var _a, _b, _c;
        return [
          ((_a = toc == null ? void 0 : toc.bottom) == null ? void 0 : _a.edit) && {
            icon: "i-heroicons-pencil-square",
            label: "Edit this page",
            to: `${toc.bottom.edit}/${(_b = page == null ? void 0 : page.value) == null ? void 0 : _b._file}`,
            target: "_blank"
          },
          ...((_c = toc == null ? void 0 : toc.bottom) == null ? void 0 : _c.links) || []
        ].filter(Boolean);
      }
    );
    return (_ctx, _push, _parent, _attrs) => {
...
//# sourceMappingURL=_...slug_-RosEDnQ6.mjs.map
