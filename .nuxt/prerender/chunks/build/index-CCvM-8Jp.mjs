import { v as nuxtLinkProps, w as config$9, u as useUI, x as getNuxtLinkProps, y as getSlotChildrenText, f as _export_sfc, l as useAsyncData, e as useAppConfig, b as __nuxt_component_0$9, _ as __nuxt_component_1$1, q as queryContent, o as useSeoMeta, t as __nuxt_component_0$a, a as __nuxt_component_0$4, z as __nuxt_component_1 } from './server.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrInterpolate, ssrRenderList, ssrRenderAttr } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/vue/server-renderer/index.mjs';
import { twJoin, twMerge } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/tailwind-merge/dist/bundle-mjs.mjs';
import { _ as __nuxt_component_0$1, h as htmlTags } from './MDCRenderer-Da3FR2NX.mjs';
...
import { kebabCase } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/scule/dist/index.mjs';
...
import { _ as __nuxt_component_0 } from './Card-B4YrbDK2.mjs';
import { createSharedComposable, useMouse, defaultWindow, watchThrottled, unrefElement } from 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/@vueuse/core/index.mjs';
...
import 'file:///Users/shawes/git/opendevsci/longitudinal.dev/node_modules/property-information/index.js';
          ...
          if (_push2) {
            ...
            if (((_a = __props.links) == null ? void 0 : _a.length) || _ctx.$slots.links) {
              ...
              ssrRenderSlot(_ctx.$slots, "links", {}, () => {
                _push2(`<!--[-->`);
                ssrRenderList(__props.links, (link2, index2) => {
              ...
              createVNode("div", {
                ...
                ((_b = __props.links) == null ? void 0 : _b.length) || _ctx.$slots.links ? (openBlock(), createBlock("div", {
                  ...
                  renderSlot(_ctx.$slots, "links", {}, () => [
                    (openBlock(true), createBlock(Fragment, null, renderList(__props.links, (link2, index2) => {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _cssVars = { style: {
        "--ffc28df2": unref(colorLight),
        "--35aaa965": unref(colorDark)
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({
        ref_key: "el",
        ref: el,
      ...
      }, unref(attrs), _attrs, _cssVars))} data-v-cc0b2707>`);
      _push(ssrRenderComponent(_component_UCard, { ui: unref(ui) }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="${ssrRenderClass(unref(ui).container)}" data-v-cc0b2707${_scopeId}>`);
            if (_ctx.to) {
              _push2(ssrRenderComponent(_component_NuxtLink, mergeProps({ "aria-label": unref(ariaLabel) }, unref(nuxtLinkBind), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<span class="absolute inset-0" aria-hidden="true" data-v-cc0b2707${_scopeId2}></span>`);
                  } else {
                    return [
                      createVNode("span", {
            ...
            if (__props.icon || _ctx.$slots.icon) {
              _push2(`<div class="${ssrRenderClass(unref(ui).icon.wrapper)}" data-v-cc0b2707${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "icon", {}, () => {
                _push2(ssrRenderComponent(_component_UIcon, {
                  name: __props.icon,
                  class: unref(ui).icon.base
            ...
            if (__props.title || _ctx.$slots.title) {
              _push2(`<p class="${ssrRenderClass(unref(ui).title)}" data-v-cc0b2707${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "title", {}, () => {
                _push2(`${ssrInterpolate(__props.title)}`);
              }, _push2, _parent2, _scopeId);
              _push2(`</p>`);
            ...
            if (__props.description || _ctx.$slots.description) {
              _push2(`<div class="${ssrRenderClass(unref(ui).description)}" data-v-cc0b2707${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "description", {}, () => {
                _push2(`${ssrInterpolate(__props.description)}`);
              }, _push2, _parent2, _scopeId);
              _push2(`</div>`);
...
const __nuxt_component_7 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-cc0b2707"]]);
const _sfc_main$1 = {
  __name: "AcknowledgmentsSection",
  __ssrInlineRender: true,
  setup(__props) {
    const labs = [
      {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "acknowledgments-section" }, _attrs))} data-v-8634b587><div class="container mx-auto" data-v-8634b587><h2 class="section-title text-black" data-v-8634b587>Acknowledgments</h2><div class="labs-container" data-v-8634b587><!--[-->`);
      ssrRenderList(labs, (lab) => {
        _push(`<div class="lab-card" data-v-8634b587><a${ssrRenderAttr("href", lab.link)} target="_blank" data-v-8634b587><img${ssrRenderAttr("src", lab.logo)}${ssrRenderAttr("alt", lab.alt)} class="lab-logo" data-v-8634b587></a><h3 data-v-8634b587>${ssrInterpolate(lab.name)}</h3><p data-v-8634b587>${ssrInterpolate(lab.description)}</p></div>`);
      });
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/AcknowledgmentsSection.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_8 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-8634b587"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ULandingSection = _sfc_main$4;
      const _component_UPageGrid = _sfc_main$3;
      const _component_ULandingCard = __nuxt_component_7;
      const _component_AcknowledgmentsSection = __nuxt_component_8;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-a80f85cc>`);
      if (unref(page).hero) {
        _push(ssrRenderComponent(_component_ULandingHero, mergeProps(unref(page).hero, { class: "custom-hero" }), {
                    ...
                    if (_push3) {
                      _push3(ssrRenderComponent(_component_NuxtLink, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<span class="absolute inset-0" aria-hidden="true" data-v-a80f85cc${_scopeId3}></span>`);
                          } else {
                            return [
                              createVNode("span", {
                                class: "absolute inset-0",
          ...
          title: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="${ssrRenderClass(unref(page).hero.titleClasses)}" data-v-a80f85cc${_scopeId}>`);
              ...
              return [
                createVNode("div", {
                  class: unref(page).hero.titleClasses
                }, [
      ...
      _push(ssrRenderComponent(_component_AcknowledgmentsSection, null, null, _parent));
      _push(`</div>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a80f85cc"]]);

export { index as default };
//# sourceMappingURL=index-CCvM-8Jp.mjs.map
